...
import FormData from 'form-data';  // Use 'form-data' package for handling form uploads
import { Buffer } from 'buffer';  // Import Buffer to handle binary data
...
// Fix to get __dirname in ES Modules
...
app.post('/upload-profile-picture', async (req, res) => {
  ...
  try {
    ...
    // Step 6: Finalize the upload (without reusing formData)
